...
class AppStateNotifier extends Notifier<Map<String, dynamic>> {
  Map<String, dynamic> siteMap = {'mainMenu': () => HomeScreen(key: UniqueKey(),), 'genreSelection': () => GenreSelectionPage(key: UniqueKey(),), 'settingsPage': () => SettingsPage(key: UniqueKey()), 'questionPage': () => QuestionPageHost(key: UniqueKey(),) };
